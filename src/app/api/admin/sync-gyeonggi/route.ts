...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const records = deduped.map(r => ({
      ...
      // 기존주택
      existing_compltn_year:  r.EXISTNG_HOUSNG_COMPLTN_PERD,
      existing_building_cnt:  ni(r.EXISTNG_HOUSNG_COPPER_CNT),
      existing_hshld_cnt:     ni(r.EXISTNG_HOUSNG_HSHLD_CNT),
      existing_hshld_u40:     ni(r.EXISTNG_HSHLD_CNT_40_DESC),
      existing_hshld_40_60:   ni(r.EXISTNG_HSHLD_CNT_40_60_DESC),
      existing_hshld_60_85:   ni(r.EXISTNG_HSHLD_CNT_60_85_DESC),
      existing_hshld_85_135:  ni(r.EXISTNG_HSHLD_CNT_85_135_DESC),
      existing_hshld_o135:    ni(r.EXISTNG_HSHLD_CNT_135_DESC),
      // 사업시행 세대수
      implmtn_hshld_total:      ni(r.BIZ_IMPLMTN_HSHLD_CNT_TOTSUM),
      member_lotout_hshld_cnt:  ni(r.ASOCNTMB_LOTOUT_HSHLD_CNT),
      general_lotout_hshld_cnt: ni(r.GENRL_LOTOUT_HSHLD_CNT),
      rent_hshld_cnt:           ni(r.RENT_HSHLD_CNT),
      // 신축 분양
      new_lotout_total:   ni(r.NWCONST_LOTOUT_HOUSNG_CNT),
      new_lotout_u40:     ni(r.NWCNST_HUSNG_LTUTAR40MUD_DESC),
      new_lotout_40_60:   ni(r.NWCNST_HUSNG_LTUTAR4060M_DESC),
      new_lotout_60_85:   ni(r.NWCNST_HUSNG_LTUTAR6085M_DESC),
      new_lotout_85_135:  ni(r.NWCNST_HUSNG_LTUTAR85135M_DESC),
      new_lotout_o135:    ni(r.NWCNST_HUSNGLTUTAR135MABV_DESC),
      // 신축 임대
      new_rent_total:  ni(r.NWCONST_RENT_HOUSNG_CNT),
      new_rent_u40:    ni(r.NWCONST_HUSNGRENTAR40MUD_DESC),
      new_rent_40_60:  ni(r.NWCONST_HUSNGRENT_AR4060M_DESC),
      new_rent_60_85:  ni(r.NWCONST_HUSNGRENT_AR6085M_DESC),
      // 용적률
      existing_far: r.EXISTNG_VOLUMRT_DESC,
      ...
      // 날짜
      rv_prearnge_zone_notif_date:  nd(r.IMPRV_PREARNGE_ZONE_NOTIFC_DE),
      rv_zone_appont_date:          nd(r.IMPRV_ZONE_APPONT_PREARNGE_DE),
      imprv_plan_foundng_date:      nd(r.IMPRV_PLAN_FOUNDNG_DE),
      zone_appont_first_date:       nd(r.IMPRV_ZONE_APPONT_FIRST_DE),
      zone_appont_change_date:      nd(r.IMPRV_ZONE_APPONT_CHANGE_DE),
      ...
      assoctn_found_confmtn_date:   nd(r.ASSOCTN_FOUND_CONFMTN_DE),
      biz_implmtn_confmtn_date:     nd(r.BIZ_IMPLMTN_CONFMTN_DE),
      manage_disposit_confmtn_date: nd(r.MANAGE_DISPOSIT_CONFMTN_DE),
